...
const MisPubliCard = () => {
    ...
    // CORRECCIÓN: Se eliminó `ciudad` del estado inicial
    ...
    const handleSelectPubli = (publi) => {
        ...
        // CORRECCIÓN: Se eliminó `ciudad` al establecer el estado para editar
        setUpdatedPubli({
            titulo: publi.titulo,
...
    };
    ...
    const handleSubmit = async (e) => {
        ...
        // Se envían region y comuna correctamente
...
                            </div>
                ...
                {misPublis.length === 0 ? (
                    ...
                    {misPublis.map((publi) => (
                        ...
                        {publi.imgURL && publi.imgURL.length > 0 && (
                            <img
